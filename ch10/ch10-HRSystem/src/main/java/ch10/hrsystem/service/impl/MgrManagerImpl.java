package ch10.hrsystem.service.impl;
...
import ch10.hrsystem.dao.AttendTypeDao;
import ch10.hrsystem.dao.CheckBackDao;
...
public class MgrManagerImpl implements MgrManager {
	...
	public List<SalaryBean> getSalaryByMgr(String mgr) throws HrException {
		...
		// 遍历本部门每个员工
		for (Employee e : emps) {
			Payment p = payDao.findByEmpAndMonth(e, payMonth);
			if (p != null) {
